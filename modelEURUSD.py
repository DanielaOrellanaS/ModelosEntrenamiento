"""
Modelo v4 EURUSD — idéntico a NAS100
...
def main():
    ...
    data = pd.read_excel(os.path.join(DATA_DIR, "Data_Entrenamiento_EURUSD.xlsx"))
    ...
    best_path        = os.path.join(MODEL_DIR, "best_trading_model_EURUSD_v4.pth")
    ...
    torch.save(model.state_dict(), os.path.join(MODEL_DIR, "trading_model_EURUSD_v4.pth"))
    scaler = {
    ...
    with open(os.path.join(MODEL_DIR, "scaler_EURUSD_v4.pkl"),        "wb") as f: pickle.dump(scaler,        f)
    with open(os.path.join(MODEL_DIR, "input_columns_EURUSD_v4.pkl"), "wb") as f: pickle.dump(input_columns, f)
    print(f"\n✅ Modelo EURUSD v4 guardado en {MODEL_DIR}")
