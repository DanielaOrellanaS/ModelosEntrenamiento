...
def main():
    ...
    # Carga y filtrado
    data = pd.read_excel(os.path.join(DATA_DIR, "Data_Entrenamiento_GER40.xlsx"))
    ...
    best_path        = os.path.join(MODEL_DIR, "best_trading_model_GER40_v4.pth")
    ...
    # Guardar
    torch.save(model.state_dict(), os.path.join(MODEL_DIR, "trading_model_GER40_v4.pth"))
    scaler = {
    ...
    with open(os.path.join(MODEL_DIR, "scaler_GER40_v4.pkl"), "wb") as f: pickle.dump(scaler, f)
    with open(os.path.join(MODEL_DIR, "input_columns_GER40_v4.pkl"), "wb") as f: pickle.dump(input_columns, f)
    print(f"\n✅ Modelo GER40 v4 guardado en {MODEL_DIR}")
