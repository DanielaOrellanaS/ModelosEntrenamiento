...
def main():
    ...
    # Carga y filtrado
    data = pd.read_excel(os.path.join(DATA_DIR, "Data_Entrenamiento_US30.xlsx"))  # ← archivo US30
    ...
    best_path        = os.path.join(MODEL_DIR, "best_trading_model_US30_v4.pth")  # ← nombre US30
    ...
    # Guardar — nombres US30
    torch.save(model.state_dict(), os.path.join(MODEL_DIR, "trading_model_US30_v4.pth"))
    scaler = {
    ...
    with open(os.path.join(MODEL_DIR, "scaler_US30_v4.pkl"), "wb") as f: pickle.dump(scaler, f)
    with open(os.path.join(MODEL_DIR, "input_columns_US30_v4.pkl"), "wb") as f: pickle.dump(input_columns, f)
    print(f"\n✅ Modelo US30 v4 guardado en {MODEL_DIR}")
